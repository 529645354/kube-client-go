...
// Note that this is identical to a secretandconfigmap volume source without the default
// mode.
...
type NodeConfigSource struct {
	...
	// 2. configMapRef and proto tag 1 were used by the API to refer to a secretandconfigmap,
